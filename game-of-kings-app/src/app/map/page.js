...
const castleImageManifest = [
  ["ashford", "exterior", "featured.png"],
  ["banefort", "exterior", "featured.png"],
  ["barrowton", "exterior", "featured.png"],
  ["blackhaven", "exterior", "featured.png"],
  ["bloody-gate", "exterior", "featured.jpg"],
  ["bronzegate", "exterior", "featured.png"],
  ["casterly-rock", "exterior", "featured.jpg"],
  ["castle-black", "exterior", "featured.jpg"],
  ["cerwyn", "exterior", "featured.webp"],
  ["cider-hall", "exterior", "featured.png"],
  ["crasters-keep", "exterior", "featured.png"],
  ["deepwood-motte", "exterior", "featured.webp"],
  ["dragonstone", "exterior", "featured.jpg"],
  ["dreadfort", "exterior", "featured.png"],
  ["duskendale", "exterior", "featured.png"],
  ["eastwatch", "exterior", "featured.png"],
  ["evenfall-hall", "exterior", "featured.jpg"],
  ["eyrie", "exterior", "featured.jpg"],
  ["fist-of-the-first-men", "exterior", "featured.png"],
  ["flints-finger", "exterior", "featured.png"],
  ["ghost-hill", "exterior", "featured.png"],
  ["greywater-watch", "exterior", "featured.webp"],
  ["griffins-roost", "exterior", "featured.png"],
  ["hardhome", "exterior", "featured.webp"],
  ["harrenhal", "exterior", "featured.png"],
  ["harvest-hall", "exterior", "featured.png"],
  ["highgarden", "exterior", "featured.png"],
  ["horn-hill", "exterior", "featured.webp"],
  ["hornwood", "exterior", "featured.png"],
  ["karhold", "exterior", "featured.png"],
  ["kings-landing", "exterior", "featured.png"],
  ["lannisport", "exterior", "featured.png"],
  ["last-hearth", "exterior", "featured.jpg"],
  ["lemonwood", "exterior", "featured.png"],
  ["moat-cailin", "exterior", "featured.png"],
  ["moles-town", "exterior", "featured.webp"],
  ["new-barrel", "exterior", "featured.png"],
  ["oldcastle", "exterior", "featured.png"],
  ["oldstones", "exterior", "featured.png"],
  ["oldtown", "exterior", "featured.jpg"],
  ["pyke", "exterior", "featured.jpg"],
  ["rains-of-summerhall", "exterior", "featured.jpg"],
  ["ramsgate", "exterior", "featured.png"],
  ["redfort", "exterior", "featured.png"],
  ["riverrun", "exterior", "featured.jpg"],
  ["rooks-rest", "exterior", "featured.png"],
  ["runestone", "exterior", "featured.png"],
  ["seagard", "exterior", "featured.webp"],
  ["shadow-tower", "exterior", "featured.png"],
  ["snakewood", "exterior", "featured.png"],
  ["starfall", "exterior", "featured.jpg"],
  ["starpike", "exterior", "featured.png"],
  ["stonehelm", "exterior", "featured.png"],
  ["storms-end", "exterior", "featured.jpg"],
  ["strongsong", "exterior", "featured.png"],
  ["sunspear", "exterior", "featured.jpg"],
  ["ten-towers", "exterior", "featured.png"],
  ["the-crag", "exterior", "featured.png"],
  ["the-tor", "exterior", "featured.png"],
  ["the-twins", "exterior", "featured.png"],
  ["torrhens-square", "exterior", "featured.webp"],
  ["white-harbor", "exterior", "featured.jpg"],
  ["wickenden", "exterior", "featured.png"],
  ["widows-watch", "exterior", "featured.png"],
  ["winterfell", "exterior", "featured-overlook.png"],
  ["winterfell", "exterior", "featured.jpg"],
  ...
  ["acorn-hall", "exterior", "desktop-acornhall.png"],
  ["antlers", "exterior", "desktop-antlers.png"],
  ["ashford", "exterior", "desktop-ashford.png"],
  ["banefort", "exterior", "desktop-banefort.png"],
  ["barrowton", "exterior", "desktop-barrowton.png"],
  ["blackhaven", "exterior", "desktop-blackhaven.png"],
  ["bloody-gate", "exterior", "desktop-bloodygate.jpg"],
  ["bronzegate", "exterior", "desktop-bronzegate.png"],
  ["casterly-rock", "exterior", "desktop-casterlyrock.jpg"],
  ["castle-black", "exterior", "desktop-castleblack.jpg"],
  ["cerwyn", "exterior", "desktop-cerwyn.webp"],
  ["cider-hall", "exterior", "desktop-ciderhall.png"],
  ["coldwater", "exterior", "desktop-coldwater.png"],
  ["crasters-keep", "exterior", "desktop-crasterskeep.png"],
  ["deep-den", "exterior", "desktop-deepden.png"],
  ["deepwood-motte", "exterior", "desktop-deepwood.webp"],
  ["dragonstone", "exterior", "desktop-dragonstone.jpg"],
  ["dreadfort", "exterior", "desktop-dreadfort.png"],
  ["duskendale", "exterior", "desktop-duskendale.png"],
  ["eastwatch", "exterior", "desktop-eastwatchbythesea.png"],
  ["evenfall-hall", "exterior", "desktop-evenfallhall.jpg"],
  ["eyrie", "exterior", "desktop-eyrie.jpg"],
  ["fist-of-the-first-men", "exterior", "desktop-fistofthefirstmen.png"],
  ["flints-finger", "exterior", "desktop-flintsfingers.png"],
  ["ghost-hill", "exterior", "desktop-ghosthill.png"],
  ["gods-eye", "exterior", "desktop-godseye.png"],
  ["greywater-watch", "exterior", "desktop-greywaterwatch.webp"],
  ["griffins-roost", "exterior", "desktop-griffinsroost.png"],
  ["hardhome", "exterior", "desktop-hardhome.webp"],
  ["harrenhal", "exterior", "desktop-harrenhal.png"],
  ["harvest-hall", "exterior", "desktop-harvesthall.png"],
  ["hayford", "exterior", "desktop-hayford.png"],
  ["hearts-home", "exterior", "desktop-heartshome.png"],
  ["high-tide", "exterior", "desktop-hightide.png"],
  ["highgarden", "exterior", "desktop-highgarden.png"],
  ["horn-hill", "exterior", "desktop-hornhill.webp"],
  ["hornwood", "exterior", "desktop-hornwood.png"],
  ["ironoaks", "exterior", "desktop-ironoaks.png"],
  ["karhold", "exterior", "desktop-karhold.png"],
  ["kings-landing", "exterior", "desktop-kingslanding.png"],
  ["lannisport", "exterior", "desktop-lannisport.png"],
  ["last-hearth", "exterior", "desktop-lasthearth.jpg"],
  ["lemonwood", "exterior", "desktop-lemonwood.png"],
  ["longbow-hall", "exterior", "desktop-longbowhall.png"],
  ["maidenpool", "exterior", "desktop-maidenpool.png"],
  ["moat-cailin", "exterior", "desktop-moatcailin.png"],
  ["moles-town", "exterior", "desktop-molestown.webp"],
  ["new-barrel", "exterior", "desktop-newbarrel.png"],
  ["old-anchor", "exterior", "desktop-oldanchor.png"],
  ["oldcastle", "exterior", "desktop-oldcastle.png"],
  ["oldstones", "exterior", "desktop-oldstone.png"],
  ["oldtown", "exterior", "desktop-oldtower.jpg"],
  ["pyke", "exterior", "desktop-pyke.jpg"],
  ["rains-of-summerhall", "exterior", "desktop-summerhall.jpg"],
  ["ramsgate", "exterior", "desktop-ramsgate.png"],
  ["raventree-hall", "exterior", "desktop-raventreehall.png"],
  ["redfort", "exterior", "desktop-redfort.png"],
  ["riverrun", "exterior", "desktop-riverrun.jpg"],
  ["rooks-rest", "exterior", "desktop-rooksrest.png"],
  ["runestone", "exterior", "desktop-runestone.png"],
  ["saltpans", "exterior", "desktop-saltpans.png"],
  ["seagard", "exterior", "desktop-seagard.webp"],
  ["shadow-tower", "exterior", "desktop-shadowtower.png"],
  ["sharp-point", "exterior", "desktop-sharppoint.png"],
  ["snakewood", "exterior", "desktop-snakewood.png"],
  ["starfall", "exterior", "desktop-starfall.jpg"],
  ["starpike", "exterior", "desktop-starpike.png"],
  ["stonedance", "exterior", "desktop-stonedance.png"],
  ["stonehelm", "exterior", "desktop-stonehelm.png"],
  ["storms-end", "exterior", "desktop-stormsend.jpg"],
  ["strongsong", "exterior", "desktop-strongsong.png"],
  ["sunspear", "exterior", "desktop-sunspear.jpg"],
  ["ten-towers", "exterior", "desktop-tentowers.png"],
  ["the-crag", "exterior", "desktop-thecrag.png"],
  ["the-tor", "exterior", "desktop-thetor.png"],
  ["the-twins", "exterior", "desktop-thetwins.png"],
  ["torrhens-square", "exterior", "desktop-torrhenssquare.webp"],
  ["tower-of-joy", "exterior", "desktop-towerofjoy.png"],
  ["white-harbor", "exterior", "desktop-whiteharbor.jpg"],
  ["wickenden", "exterior", "desktop-wickenden.png"],
  ["widows-watch", "exterior", "desktop-widowswatch.png"],
  ["winterfell", "exterior", "desktop-winterfel.jpg"],
  ["winterfell", "exterior", "desktop-winterfeloverlook.png"],
];
...
const printedMapLocations = [
  ...
  ["tumbleton", "Tumbleton", "The Reach", 45.8, 82.3],
  ...
  ["cleganes-keep", "Clegane's Keep", "Westerlands", 24.0, 71.0],
...
const markerPositionOverrides = {
  ...
  "redfort": [62.45, 59.45],
  "gulltown": [72.05, 58.86],
  "lord-harroways-town": [47.56, 61.42],
  "riverrun": [35.96, 61.99],
  "harrenhal": [45.62, 63.92],
  "raventree-hall": [42.9, 63.9],
  "gods-eye": [46.65, 66.12],
  "wickenden": [57.99, 62.96],
  "saltpans": [51.08, 62.15],
  "maidenpool": [53.85, 63.15],
  "casterly-rock": [15.42, 69.55],
  "pinkmaiden": [32.5, 66.05],
  "antlers": [52.15, 66.32],
  "stone-hedge": [40.4, 64.1],
  "acorn-hall": [41.5, 63.15],
  "darry": [52.25, 66.25],
  "lannisport": [13.85, 71.58],
  "rooks-rest": [64.85, 65.0],
  "hayford": [47.72, 70.14],
  "duskendale": [59.19, 67.85],
  "high-tide": [66.75, 66.72],
  "kayce": [11.62, 68.3],
  "faircastle": [14.35, 65.55],
  "the-crag": [18.7, 63.48],
  "banefort": [19.55, 60.42],
  "kings-landing": [56.22, 72.05],
  "eelwood": [54.41, 75.93],
  "dragonstone": [68.55, 65.62],
  "sharp-point": [68.75, 69.0],
  "stonedance": [69.34, 71.35],
  "crakehall": [13.32, 74.62],
  "cornfield": [21.6, 73.8],
  "goldengrove": [25.78, 76.7],
  "golden-tooth": [24.55, 65.05],
  "haystack-hall": [62.58, 76.26],
  "evenfall-hall": [71.3, 78.0],
  "storms-end": [66.32, 79.14],
  "old-oak": [15.02, 79.46],
  "bronzegate": [58.15, 76.95],
  "bitterbridge": [37.7, 75.4],
  "grassy-vale": [45.45, 76.5],
  "cider-hall": [32.85, 81.65],
  "ashford": [39.62, 80.88],
  "longtable": [35.4, 79.27],
  "rains-of-summerhall": [51.0, 80.9],
  "tumbleton": [45.55, 82.25],
  "griffins-roost": [62.65, 81.65],
  "rain-house": [70.6, 82.42],
  "harvest-hall": [42.58, 82.05],
  "mistwood": [65.39, 84.57],
  "blackhaven": [45.86, 83.48],
  ...
  "ashemark": [22.0, 64.4],
  "sarsfield": [20.2, 67.25],
  "hornvale": [26.65, 66.08],
  "deep-den": [27.95, 68.0],
  "cleganes-keep": [22.88, 69.65],
  "silverhill": [27.08, 70.8],
  "yronwood": [45.15, 89.88],
  "three-towers": [13.93, 92.68],
  "blackcrown": [11.21, 91.3],
  "starfall": [28.1, 93.36],
  "skyreach": [40.15, 91.05],
  "kingsgrave": [38.2, 88.6],
  "the-tor": [58.95, 91.45],
